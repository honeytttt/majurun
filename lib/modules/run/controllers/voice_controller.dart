...
const List<String> _kEncouragements = [
  ...
  'Keep going — you are doing something most people only talk about!',
  'One more step — keep moving forward!',
  'Breathe, focus, keep running!',
  'You have come too far to stop now!',
  'Your body has more in it — dig deep!',
  'Run with pride — you have earned every step!',
  'Every drop of sweat is proof of your effort!',
  'Remember your goal — run towards it!',
  'Your legs are still moving — that is enough to keep going!',
  'Real runners do not quit — press on!',
  'Every kilometer is an achievement — celebrate this one!',
  'Your mind is strong — let it lead your body!',
  'Today you are better than yesterday!',
  'You chose to run today — that is already a win!',
  'A journey of a thousand miles begins with a single step — keep stepping!',
  'Your body knows how — trust it!',
  'Smile — you are doing something extraordinary!',
  'You are not just running — you are building a stronger version of yourself!',
  'Pain is temporary, pride is forever — keep pushing!',
  'Champions are made in the moments they want to quit but do not!',
];
