...
**Current TestFlight version:** `1.0.4+249` — app opens on RUN tab by default (was Home feed) + shared run cards carry a tappable download link (`majurun.com/get` → App Store/Play Store by device). (248 run post-text + 247 double-submit + 246 START + 245 audio + 244 freeze all included.)
