...
- Last known upload: **build 224** (version 1.0.2+224) — Apple rejection fixes uploaded successfully
- **Release in progress: build 225** (version 1.0.2+225) — bump after functions-only push caused duplicate upload attempt
