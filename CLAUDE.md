...
**Current TestFlight version:** `1.0.5+256` — Play Billing Library 8.0.0 + Voice Coach discoverability + Sentry/Crashlytics handler chaining. See "Build 256" below. ⚠️ DEVICE-TEST a sandbox purchase (Android) before this goes anywhere near production.
