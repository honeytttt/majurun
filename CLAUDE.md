...
**Current TestFlight version:** `1.0.4+248` — run post-text fixes (km km / 00:00 / >1hr duration). (247 double-submit guards + 246 START + 245 audio + 244 freeze all included.)
