...
**Current TestFlight version:** `1.0.4+245` — Android audio fix: music (Spotify) no longer STOPS — ducks instead. (244 = home-feed freeze fix + comment picker guard, still included.)
